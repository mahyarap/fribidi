 ...
 * $Revision: 1.2 $
 * $Source:
 * /home/behdad/src/fdo/fribidi/togit/git/../fribidi/fribidi2/charset/fribidi-char-sets-utf8.h,v
 *$
 *
 * Authors:
...
FriBidiStrIndex fribidi_utf8_to_unicode(const char *s, FriBidiStrIndex length,
					FriBidiChar *us);

#define fribidi_unicode_to_utf8 FRIBIDI_NAMESPACE(unicode_to_utf8)
FriBidiStrIndex fribidi_unicode_to_utf8(const FriBidiChar *us,
					FriBidiStrIndex length, char *s);
