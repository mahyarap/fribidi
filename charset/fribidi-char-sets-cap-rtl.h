 ...
 * $Revision: 1.2 $
 * $Source:
 * /home/behdad/src/fdo/fribidi/togit/git/../fribidi/fribidi2/charset/fribidi-char-sets-cap-rtl.h,v
 *$
 *
 * Authors:
...
FriBidiStrIndex fribidi_cap_rtl_to_unicode(const char *s,
					   FriBidiStrIndex length,
					   FriBidiChar *us);

#define fribidi_unicode_to_cap_rtl FRIBIDI_NAMESPACE(unicode_to_cap_rtl)
FriBidiStrIndex fribidi_unicode_to_cap_rtl(const FriBidiChar *us,
