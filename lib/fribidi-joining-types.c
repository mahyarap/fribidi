 ...
 * $Revision: 1.5 $
 * $Source:
 * /home/behdad/src/fdo/fribidi/togit/git/../fribidi/fribidi2/lib/fribidi-joining-types.c,v
 *$
 *
 * Authors:
...
FRIBIDI_ENTRY FriBidiJoiningType fribidi_get_joining_type(
    /* input */
    FriBidiChar ch)
{
...
FRIBIDI_ENTRY void fribidi_get_joining_types(
    /* input */
    const FriBidiChar *str, const FriBidiStrIndex len,
    /* output */
...
#define _FRIBIDI_ADD_TYPE(TYPE, SYMBOL)                                        \
	case FRIBIDI_JOINING_TYPE_##TYPE:                                      \
...
char fribidi_char_from_joining_type(
    /* input */
    FriBidiJoiningType j, fribidi_boolean visual)
{
...
#define _FRIBIDI_ADD_TYPE(TYPE, SYMBOL)                                        \
	if (FRIBIDI_IS_JOINING_TYPE_##TYPE(j))                                 \
		return SYMBOL;
#include "fribidi-joining-types-list.h"
#undef _FRIBIDI_ADD_TYPE
