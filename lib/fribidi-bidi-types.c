 ...
 * $Revision: 1.9 $
 * $Source:
 * /home/behdad/src/fdo/fribidi/togit/git/../fribidi/fribidi2/lib/fribidi-bidi-types.c,v
 *$
 *
 * Authors:
    ...
    FriBidiCharType *btypes)
{
	...
	for (; i; i--) {
		*btypes++ =
		    linear_enum_to_char_type[FRIBIDI_GET_BIDI_TYPE(*str)];
		str++;
	}
}
...
char fribidi_char_from_bidi_type(
    /* input */
    FriBidiCharType t)
{
	switch (t) {
