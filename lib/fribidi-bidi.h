...
FRIBIDI_ENTRY FriBidiLevel fribidi_get_par_embedding_levels(
    ...
    FriBidiLevel *embedding_levels) FRIBIDI_GNUC_WARN_UNUSED;
 ...
 *
 * @param flags reorder flags
 * @param bidi_types input list of bidi types as returned by 
 *        fribidi_get_bidi_types()
 * @param len input length of the line
 * @param off input offset of the beginning of the line in the paragraph
 * @param base_dir resolved paragraph base direction
 * @param embedding_levels input list of embedding levels, as returned by
		  fribidi_get_par_embedding_levels()
 * @param visual_str visual string to reorder
 * @param map a map of string indices which is reordered to reflect where 
 *        each glyph ends up
 *
...
FRIBIDI_ENTRY FriBidiLevel fribidi_reorder_line(
    ...
    FriBidiStrIndex *map) FRIBIDI_GNUC_WARN_UNUSED;
