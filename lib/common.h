 ...
 * $Revision: 1.21 $
 * $Source:
 * /home/behdad/src/fdo/fribidi/togit/git/../fribidi/fribidi2/lib/common.h,v $
 *
 * Author:
...
#define FRIBIDI_PRIVATESPACE(SYMBOL)                                           \
	FRIBIDI_PRIVATESPACE0(_, FRIBIDI_NAMESPACE(_##SYMBOL##__internal__))
