 ...
 * $Revision: 1.10 $
 * $Source:
 * /home/behdad/src/fdo/fribidi/togit/git/../fribidi/fribidi2/lib/debug.h,v $
 *
 * Author:
...
#ifndef MSG
#define MSG(s)                                                                 \
	FRIBIDI_BEGIN_STMT FRIBIDI_FPRINTF(FRIBIDI_STDERR_ s);                 \
	FRIBIDI_END_STMT
#define MSG2(s, t)                                                             \
	FRIBIDI_BEGIN_STMT FRIBIDI_FPRINTF(FRIBIDI_STDERR_ s, t);              \
	FRIBIDI_END_STMT
#define MSG5(s, t, u, v, w)                                                    \
	FRIBIDI_BEGIN_STMT FRIBIDI_FPRINTF(FRIBIDI_STDERR_ s, t, u, v, w);     \
	FRIBIDI_END_STMT
#endif /* !MSG */

#ifndef DBG
#define DBG(s)                                                                 \
	FRIBIDI_BEGIN_STMT if (fribidi_debug_status())                         \
	{                                                                      \
		MSG(FRIBIDI ": " s "\n");                                      \
	}                                                                      \
	FRIBIDI_END_STMT
...
#define fribidi_assert(cond)                                                   \
	FRIBIDI_BEGIN_STMT if (!(cond))                                        \
	{                                                                      \
		DBG(__FILE__ ":" STRINGIZE(                                    \
		    __LINE__) ": "                                             \
