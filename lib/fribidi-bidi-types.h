 ...
 * $Revision: 1.15 $
 * $Source:
 * /home/behdad/src/fdo/fribidi/togit/git/../fribidi/fribidi2/lib/fribidi-bidi-types.h,v
 *$
 *
 * Author:
...
#define FRIBIDI_MASK_NUMSEPTER                                                 \
	0x00000400L /* Is separator or terminator: ES, ET, CS */
#define FRIBIDI_MASK_SPACE 0x00000800L /* Is space: BN, BS, SS, WS */
#define FRIBIDI_MASK_EXPLICIT                                                  \
	0x00001000L /* Is expilict mark: LRE, RLE, LRO, RLO, PDF */
 ...
 */
#if defined(__FRIBIDI_DOC) ||                                                  \
    (FRIBIDI_SIZEOF_INT + 0 == 4 && !defined(__cplusplus))
...
/* Is ES or CS: ES, CS? */
#define FRIBIDI_IS_ES_OR_CS(p) ((p) & (FRIBIDI_MASK_ES | FRIBIDI_MASK_CS))
...
/* Is explicit or separator or BN or WS: LRE, RLE, LRO, RLO, PDF, BS, SS, BN,
 * WS? */
