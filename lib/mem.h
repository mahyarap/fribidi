 ...
 * $Revision: 1.7 $
 * $Source:
 * /home/behdad/src/fdo/fribidi/togit/git/../fribidi/fribidi2/lib/mem.h,v $
 *
 * Author:
...
#define fribidi_chunk_new(type, chunk) ((type *)fribidi_mem_chunk_alloc(chunk))

#define fribidi_chunk_new_for_type(type)                                       \
	(fribidi_mem_chunk_new(FRIBIDI, sizeof(type), FRIBIDI_CHUNK_SIZE,      \
			       FRIBIDI_ALLOC_ONLY))
